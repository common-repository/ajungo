...
/*
Plugin Name: Ajungo
Plugin URI: http://wordpress.org/plugins/ajungo/
Description: Ajungo - Social Lead Capture. Capture leads and data with our Facebook Login widget. All on your site with no coding knowledge necessary.
Author: Ajungo
Author URI: http://ajungo.com/
Version: 1.0
License: GPLv2 or later
Text Domain: ajungo

Copyright 2014 Ajungo (http://ajungo.com/)
...
spl_autoload_register('Ajungo::autoload');
...
class Ajungo
{
    ...
    const TEXT_DOMAIN         = 'ajungo';
    const OPTION_KEY          = 'ajungo';
    const FILE                = __FILE__;
...
add_action('plugins_loaded', array('Ajungo', 'getInstance'));
